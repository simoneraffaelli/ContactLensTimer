...
import com.raffynato.contactlenstimer.database.DatabaseManager;
import com.raffynato.contactlenstimer.listeners.OnAppBarButtonClick;
import com.raffynato.contactlenstimer.listeners.OnChipClick;
import com.raffynato.contactlenstimer.listeners.OnFabClick;
import com.raffynato.contactlenstimer.listeners.PullToFragmentDismiss;
...
public class MainActivity extends AppCompatActivity implements OnAppBarButtonClick, OnFabClick, PullToFragmentDismiss, OnChipClick {
    ...
    */
    ...
    public void setupNotifications(List<Lens> lenses) {
        if (lenses.get(0).getExpDate().isEqual(lenses.get(1).getExpDate())) {
            ...
            //NotificationScheduler.setReminder(this, AlarmReceiver.class, lenses.get(0).getExpDate().getDayOfYear(), new DateTime().withMinuteOfHour(0).getMinuteOfHour(), new DateTime().withHourOfDay(20).getHourOfDay(), LX_LENS_NOT_ID);
            ...
            NotificationScheduler.setReminder(this, AlarmReceiver.class, new DateTime().getDayOfYear(), new DateTime().plusMinutes(1).getMinuteOfHour(), new DateTime().getHourOfDay(), RX_LENS_NOT_ID);
            NotificationScheduler.setReminder(this, AlarmReceiver.class, new DateTime().getDayOfYear(), new DateTime().plusMinutes(1).getMinuteOfHour(), new DateTime().getHourOfDay(), LX_LENS_NOT_ID);
